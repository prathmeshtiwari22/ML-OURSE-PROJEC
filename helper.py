...
def data_over_time(df, col):
    # Drop duplicates based on 'Year' and the specified column 'col'
    data = df.drop_duplicates(['Year', col])['Year'].value_counts().reset_index()
    data.columns = ['Year', col]  # Rename columns appropriately
...
def most_successful_countrywise(df, country):
    ...
    # Count the number of medals for each athlete and reset index
    x = temp_df['Name'].value_counts().reset_index()
    x.columns = ['Name', 'Medals']  # Renaming columns for clarity
