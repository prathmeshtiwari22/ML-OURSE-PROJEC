...
if user_menu == 'Country-wise Analysis':
    ...
    # Create a DataFrame to plot based on the selected country
    if 'Year' in country_df.columns and 'Medal' in country_df.columns:
        fig = px.line(country_df, x='Year', y='Medal', title=f"{selected_country} Medal Tally over the years")
        st.plotly_chart(fig)
    else:
        st.error("Error: Expected columns not found in country_df DataFrame.")
